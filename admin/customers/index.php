...
$pdo = getPDO();
$rows = $pdo->query('SELECT * FROM customers ORDER BY id DESC')->fetchAll(PDO::FETCH_ASSOC);
?>
...
<table class="table table-striped table-bordered">
    <thead><tr><th>No</th><th>Customer Code</th><th>Nama</th><th>Status</th><th>Aksi</th></tr></thead>
    <tbody>
        <?php $i=1; foreach($rows as $r): ?>
            <tr>
                <td><?php echo $i++; ?></td>
                <td><?php echo esc($r['customer_code']); ?></td>
                ...
                <td>
                    ...
                    <form method="post" action="delete.php" style="display:inline-block;" onsubmit="return confirm('Hapus customer?');">
