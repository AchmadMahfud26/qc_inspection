...
$pdo = getPDO();
$stmt = $pdo->prepare('DELETE FROM customers WHERE id = :id'); $stmt->execute([':id'=>$id]);
set_flash('success','Customer dihapus.'); log_activity($pdo, current_user()['id'], 'Delete Customer id:'.$id, 'Customer', (string)$id);
