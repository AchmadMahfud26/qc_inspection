...
$page_title = 'Edit After Painting Inspection';
...
$header_sql = "SELECT 
            ...
            WHERE ih.id = $id AND ih.inspection_type = 'After Painting'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            // Log activity
            logActivity($db, $_SESSION['user']['id'], 'Update', 'After Painting Inspection', $header['inspection_no']);
...
<div class="container-fluid pt-4">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2 class="page-title">Edit After Painting Inspection</h2>
