...
$page_title = 'Edit Final Check Inspection';
...
$header_sql = "SELECT 
            ...
            WHERE ih.id = $id AND ih.inspection_type = 'Final Check'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            // Log activity
            logActivity($db, $_SESSION['user']['id'], 'Update', 'Final Check Inspection', $header['inspection_no']);
...
<div class="container-fluid pt-4">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2 class="page-title">Edit Final Check Inspection</h2>
