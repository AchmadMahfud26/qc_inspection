...
$sql = "SELECT 
        ...
        WHERE ih.inspection_type = 'After Welding'
...
// Get total records
$total_sql = "SELECT COUNT(*) as total FROM inspection_headers WHERE inspection_type = 'After Welding'";
...
// Page title
$page_title = 'After Welding Inspection';
?>
...
<div class="container-fluid pt-4">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2 class="page-title">After Welding Inspection</h2>
            <p class="text-muted">Data inspeksi produk setelah proses welding</p>
        </div>
        <div class="col-md-4 text-end">
            <?php if (in_array($_SESSION['user']['role'], ['admin', 'qc_inspector'])): ?>
                <a href="<?php echo BASE_URL; ?>/inspection/after_welding/create.php" class="btn btn-primary">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                    $pass_sql = "SELECT COUNT(*) as total FROM inspection_headers WHERE inspection_type = 'After Welding' AND final_result = 'PASS'";
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                    $ng_sql = "SELECT COUNT(*) as total FROM inspection_headers WHERE inspection_type = 'After Welding' AND final_result = 'NG'";
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                    $hold_sql = "SELECT COUNT(*) as total FROM inspection_headers WHERE inspection_type = 'After Welding' AND final_result = 'HOLD'";
