...
<div class="sidebar-container bg-dark text-white vh-100 p-3">
    ...
    <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item mt-3"><strong class="text-white ps-2">Master Data</strong></li>
        ...
        <li class="nav-item mt-3"><strong class="text-white ps-2">Inspection</strong></li>
        ...
        <li class="nav-item mt-3"><strong class="text-white ps-2">Data & Analysis</strong></li>
        ...
        <li class="nav-item mt-3"><strong class="text-white ps-2">Lainnya</strong></li>
